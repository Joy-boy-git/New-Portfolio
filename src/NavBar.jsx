...
const NavBar = () => {
  ...
  return (
    <div>
      <nav className="flex justify-between items-center border-1 border-pink-500 p-4 shadow-lg bg-black relativefixed t-0">
        <h1 className="flex font-sanserif font-bold gap-2 text-3xl text-white" data-aos="fade-right">BERLIN <span className="text-3xl text-white"> S P</span></h1>
